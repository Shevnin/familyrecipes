...
## 2026-02-22
- 2026-02-22 — Принята рекомендованная схема совместной работы (Человек + ChatGPT + Claude) с каноничным workflow в `/docs/workflow.md` и task-card шаблоном в `/docs/tasks/_template.md`.
