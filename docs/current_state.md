...
- Последняя зафиксированная сессия: `docs/sessions/2026-02-25_docs_handoff_link_flow.md`
- Текущий прототип: `src/index.html`
- Публичный URL: https://shevnin.github.io/familyrecipes/src/index.html

## Что умеет прототип
1. **Передатчик (Мама):** набирает рецепт → выбирает получателя (сыну/дочке) → отправляет. Вкладка "Отправленные".
